...
const ArmyListCardV2 = ({
  ...
  return (
    <Pressable key={armyList.armyId} onPress={() => handleArmyListPress(armyList.armyId)}>
      <View
        style={{
          overflow: 'hidden',
        ...
        <View style={{ flex: 3, margin: 16 }}>
          ...
          <View style={{ marginBottom: 4 }}>
            <Text>{armyList.factionName}</Text>
          </View>
        ...
        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'flex-end' }}>
          <View
            ...
            <Image style={[styles.stretch]} source={armyList.imageUri} />
          </View>
          <LinearGradient
            colors={[
              'rgba(31,46,39, 0.9)',
