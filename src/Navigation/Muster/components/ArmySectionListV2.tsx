...
export type BuilderHomeListProps = {
  sectionListData: ArmySectionListDataV2Props[];
      ...
      <SectionList
        ...
        renderItem={({ item, index }) => {
          ...
          return (
            <ArmyListCardV2
              userArmy={item}
              onArmyListCardPress={onArmyListPress}
              onToggleFavourite={function (armyId: string): void {
                throw new Error('Function not implemented.');
              }}
              onDuplicateArmyPress={function (armyId: string): void {
                throw new Error('Function not implemented.');
              }}
              onArmyNameChange={function (armyId: string): void {
                throw new Error('Function not implemented.');
              }}
              onDeleteArmyPress={function (armyId: string): void {
                throw new Error('Function not implemented.');
              }}
            />
            // <ArmyListCard
      ...
      <StandardModal
        ...
        content={
          <View>
            ...
            <TextBlock>
              <CustomText>
                Migration will create a <CustomText bold>duplicated army list</CustomText> that will appear at the bottom of the list.
              </CustomText>
            </TextBlock>
            <CustomText>
              Your old list will <CustomText bold>still be accessible</CustomText> after migration, and can be deleted at any time.
            </CustomText>
          </View>
        }
        ...
        cancelText={'I will do this later'}></StandardModal>
      <StandardModal
        ...
        onCancel={() => setShowFilterModal(false)}></StandardModal>
    </View>
  );
};
