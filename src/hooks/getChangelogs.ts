...
import change1_2_42 from "../data/changelogs/2026/1_2_42.json";

export const ChangeLogs: ChangeLog[] = [change1_2_36 as ChangeLog, change1_2_37 as ChangeLog, change1_2_38 as ChangeLog, change1_2_39 as ChangeLog, change1_2_40 as ChangeLog, change1_2_41 as ChangeLog, change1_2_42 as ChangeLog];

export const useChangeLogs = () => {
	const getChangeLogsByVersion = (version: string) => {
		console.log("🚀 ~ getChangeLogsByVersion ~ version:", version)
		// get change logs
		const changeLogFound = [...ChangeLogs].reverse().find((x) => x.version === version);
